...
export default class TheGodsDashboard extends DomNode {
    ...
    constructor() {
        ...
        this.append(el("section.stats", el("h3", "Global Stats"), this.statsContent = el(".content")), el("section.graph", this.graphTabGroup = new TabGroup(new Tab({ label: "Holders", value: "numOwners" }), new Tab({ label: "Floor Price", value: "floorPrice" })), this.graph = new TheGodsGraph("numOwners")));
