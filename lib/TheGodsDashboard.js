...
export default class TheGodsDashboard extends DomNode {
    ...
    constructor() {
        ...
        this.append(el("section.stats", el("h2", "Global Stats"), this.statsContent = el(".content")), el("section", new TheGodsGraph("30d", "numOwners")), el("section", el("h2", "Top God collectors")));
